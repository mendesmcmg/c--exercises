...
// Input
// The input file contains 2 integer numbers and 1 
// value of floating point, representing the number,
// worked hours amount and the amount the employee 
// receives per worked hour.

// Output
// Print the number and the employee's salary, 
// according to the given example, with a blank space
